...
extern MY_HIGHP_OR_MEDIUMP vec2 parasite;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float newBrightness = min(1.0,(1.0 - brightness)*1.1);

    pixelColor.r = newBrightness;
    pixelColor.g = newBrightness;
    pixelColor.b = (newBrightness*0.85)+0.15; //Slightly more blue
